-- PostgreSQL dataset script
DROP TABLE IF EXISTS pedidos; DROP TABLE IF EXISTS clientes; DROP TABLE IF EXISTS cidades;
...
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (1, 'Francis Faria', 'francis.faria@example.com', 2, TRUE, '2025-05-21 07:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (2, 'Ana Silva', 'ana.silva@example.com', 4, TRUE, '2025-02-22 21:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (3, 'João Souza', 'joão.souza@example.com', 9, TRUE, '2025-10-30 13:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (4, 'Maria Oliveira', 'maria.oliveira@example.com', 1, TRUE, '2025-02-17 06:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (5, 'Carlos Santos', 'carlos.santos@example.com', 4, TRUE, '2025-10-15 06:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (6, 'Beatriz Almeida', 'beatriz.almeida@example.com', 9, FALSE, '2025-04-23 14:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (7, 'Rafael Costa', 'rafael.costa@example.com', 10, TRUE, '2025-01-04 05:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (8, 'Fernanda Lima', 'fernanda.lima@example.com', 7, TRUE, '2025-05-23 04:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (9, 'Paulo Henrique', 'paulo.henrique@example.com', 4, TRUE, '2025-02-22 02:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (10, 'Luiza Rocha', 'luiza.rocha@example.com', 7, TRUE, '2025-07-03 11:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (11, 'Gustavo Nogueira', 'gustavo.nogueira@example.com', 10, TRUE, '2025-01-23 23:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (12, 'Camila Ferreira', 'camila.ferreira@example.com', 8, TRUE, '2025-07-13 02:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (13, 'Bruno Ribeiro', 'bruno.ribeiro@example.com', 9, TRUE, '2025-11-18 19:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (14, 'Patrícia Gomes', 'patrícia.gomes@example.com', 6, TRUE, '2025-12-27 02:00:00');
INSERT INTO clientes (id, nome, email, cidade_id, ativo, criado_em) VALUES (15, 'Marcos Vinícius', 'marcos.vinícius@example.com', 1, TRUE, '2025-05-29 02:00:00');
